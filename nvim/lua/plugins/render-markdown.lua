...
return {
  ...
  init = function()
    ...
    local color1_bg = "#E06C75"
    local color2_bg = "#E5C07B"
    local color3_bg = "#61AFEF"
    local color4_bg = "#D19A66"
    local color5_bg = "#98C379"
    local color6_bg = "#C678DD"
    local color_fg = "#101010"
